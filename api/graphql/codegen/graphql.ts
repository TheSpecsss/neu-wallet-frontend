...
export type Mutation = {
  ...
  topUp?: Maybe<Wallet>;
  transferBalanceByUserEmail?: Maybe<WalletTransfer>;
  transferBalanceByUserId?: Maybe<WalletTransfer>;
...
export type MutationTransferBalanceByUserEmailArgs = {
  amount: Scalars['Int']['input'];
  receiverEmail: Scalars['String']['input'];
};


export type MutationTransferBalanceByUserIdArgs = {
  amount: Scalars['Int']['input'];
  receiverId: Scalars['String']['input'];
};
...
export type SetBalanceMutationVariables = Exact<{
  userId: Scalars['String']['input'];
  balance: Scalars['Int']['input'];
}>;


export type SetBalanceMutation = { __typename?: 'Mutation', setBalance?: { __typename?: 'Wallet', balance: number, id: string, updatedAt: string } | null };

export type TransferBalanceByUserIdMutationVariables = Exact<{
  receiverId: Scalars['String']['input'];
  amount: Scalars['Int']['input'];
}>;


export type TransferBalanceByUserIdMutation = { __typename?: 'Mutation', transferBalanceByUserId?: { __typename?: 'WalletTransfer', receiverWallet: { __typename?: 'Wallet', balance: number, id: string, updatedAt: string }, senderWallet: { __typename?: 'Wallet', id: string, updatedAt: string, balance: number } } | null };
...
export type TransferBalanceByUserEmailMutation = { __typename?: 'Mutation', transferBalanceByUserEmail?: { __typename?: 'WalletTransfer', receiverWallet: { __typename?: 'Wallet', balance: number } } | null };
