...
import RegisterEmailConfirmScreen from "./screens/RegisterEmailConfirmScreen";
...
const App = () => {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <NavigationContainer>
        <MainStack.Navigator initialRouteName="RegisterEmailConfirmScreen">
          <MainStack.Screen
            name="SplashScreen"
          ...
          />
          <MainStack.Screen
            name="RegisterEmailConfirmScreen"
            component={RegisterEmailConfirmScreen}
            options={{ headerShown: false }}
          />
          <MainStack.Screen
            name="EditUserScreen"
