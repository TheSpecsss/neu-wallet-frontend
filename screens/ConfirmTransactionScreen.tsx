    ...
    <View style={styles.container}>
        ...
        <View style={styles.detailsContainer}>
            ...
            <View style={styles.detailItem}>
                ...
                <Text style={styles.detailValue}>₱{transactions.amount.toFixed(2)}</Text>
            </View>
            <View style={styles.detailItem}>
                <Text style={styles.detailLabel}>Date & Time:</Text>
                <Text style={styles.detailValue}>{transactions.date} {transactions.time}</Text>
            </View>
            <View style={styles.detailItem}>
