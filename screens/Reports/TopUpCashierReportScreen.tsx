...
const transactions: Transaction[] = [
  { time: '09:15 AM', id: '#0001', items: 3, method: 'Cashout', amount: 125.5 },
  { time: '10:30 AM', id: '#0002', items: 2, method: 'TopUp', amount: 75.25 },
  { time: '11:45 AM', id: '#0003', items: 5, method: 'CashOut', amount: 200.0 },
  { time: '01:20 PM', id: '#0004', items: 1, method: 'Payment', amount: 45.75 },
  { time: '02:35 PM', id: '#0005', items: 4, method: 'Payment', amount: 150.25 },
];

const totalSales = transactions.reduce((acc, t) => acc + t.amount, 0);
const averageSale = totalSales / transactions.length;

const TopUpCashierReportScreen = () => {
  return (
